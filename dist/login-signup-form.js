...
var anotherArrayOfNumber = Array.from(arrayOfNumber);
var newArrayofNumber = anotherArrayOfNumber.map(function (n) {
  return n + 1;
});
...
console.log(arrayOfNumber.find(function (n) {
  return n === 4;
}), 'expect ' + 4);
console.log(arrayOfNumber.findIndex(function (n) {
  return n === 4;
}), 'expect ' + 3);
...
var name = 'John',
    apples = 5,
    pears = 7,
    bananas = function bananas() {
  return 3;
};
console.log('He carries ' + apples + ' apples, ' + pears + ' pears, and ' + bananas());

// React HelloWorld
_reactDom2.default.render(_react2.default.createElement(_HelloWorld.HelloWorld, null), document.getElementById('example'));

},{"./components/HelloWorld.jsx":159,"react":157,"react-dom":28}],159:[function(require,module,exports){
"use strict";
...
var _UserNameInput = require("./UserNameInput.jsx");
  ...
  _createClass(HelloWorld, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_UserNameInput.EmailUserNameInput, null)
      );
    }
  }]);
...
},{"./UserNameInput.jsx":160,"react":157}],160:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.EmailUserNameInput = undefined;
...
var EmailUserNameInput = exports.EmailUserNameInput = function (_React$Component) {
  _inherits(EmailUserNameInput, _React$Component);

  function EmailUserNameInput() {
    _classCallCheck(this, EmailUserNameInput);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(EmailUserNameInput).apply(this, arguments));
  }

  _createClass(EmailUserNameInput, [{
    key: "render",
    value: function render() {
      return _react2.default.createElement("input", { type: "email", maxLength: "50", max: "50" });
    }
  }]);
